...
# Скрипт для развертывания YesExpress на сервере 89.39.94.187

set -e

echo "🚀 Начинаем развертывание YesExpress..."
...
echo "🔌 WebSocket доступен по адресу: ws://89.39.94.187/webs/"
